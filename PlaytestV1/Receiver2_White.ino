/*
 * Wobble Unified - Receiver 2 (White Rocker)
 * Adafruit QT Py ESP32-S3
 * 
 * This board:
 * - Scans for BLE beacon and detects proximity
 * - Sends proximity events to port 8002 (/proximity/distance)
 * - Sends LSM6DSOX sensor data to port 8006
 * 
...
// OSC ports
const int oscProximityPort = 8002;  // Port for /proximity/distance messages
const int oscSensorPort = 8006;      // Port for LSM6DSOX sensor data
const int oscLocalPort = 9002;       // Local port for OSC
...
void setup() {
  ...
  Serial.println("\n========================================");
  Serial.println("Wobble Unified - Receiver 2 (White)");
  ...
  BLEDevice::init("QTPy_Receiver2_White");
  ...
  Serial.println("  Port 8002: /proximity/distance (distance + in_range)");
  Serial.println("  Port 8006: Sensor bundle (25Hz)");

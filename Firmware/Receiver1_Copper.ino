/*
 * Wobble Unified - Receiver 1 (Copper Rocker)
 * Adafruit QT Py ESP32-S3
 * 
 * This board:
 * - Scans for BLE beacon and detects proximity
 * - Sends proximity events to port 8001 (/proximity/distance)
 * - Sends LSM6DSOX sensor data to port 8004
 * 
...
// OSC ports
const int oscProximityPort = 8001;  // Port for /proximity/distance messages
const int oscSensorPort = 8004;      // Port for LSM6DSOX sensor data
const int oscLocalPort = 9000;       // Local port for OSC
...
void setup() {
  ...
  Serial.println("\n========================================");
  Serial.println("Wobble Unified - Receiver 1 (Copper)");
  ...
  BLEDevice::init("QTPy_Receiver1_Copper");
  ...
  Serial.println("  Port 8001: /proximity/distance (distance + in_range)");
  Serial.println("  Port 8004: Sensor bundle (25Hz)");
